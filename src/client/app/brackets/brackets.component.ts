...
export class BracketsComponent implements OnInit {
  ...
  constructor(private mysqlService: TeamService) { //Injects teamservice so that the data for porducts can be accessed with the local variable productService
  ...
  testGetTeams() {
    this.mysqlService.getTeams().subscribe((teams: iTeam[]) => {
      console.log(teams);
    });
  }
}
